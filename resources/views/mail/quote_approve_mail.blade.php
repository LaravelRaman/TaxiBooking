            ...
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td><img src="{{ asset('frontend/images/logo.png') }}" alt=""
                            ...
                            <tr>
                                <td>
                                    <h2 class="title">Quotation Approved</h2>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p style="color:#aba8a8;">Quotation Request Received, and Your Quotation is Approved
                                    </p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <h2 style="text-transform: capitalize;font-style: italic;color: #444444;">Quotation
                                        Received</h2>
                            ...
                            <tr>
                                <td style="background-color: #fafafa;padding: 15px;letter-spacing: 0.3px;width: 50%;">
                                    ...
                                    <p
                                        ...
                                        {{ $data['starting_point'] }}</p>
                                </td>
                                <td class="user-info" width="57" height="25"><img
                                        src="{{ asset('admin/assets/images/email-template/space.jpg') }}" alt=" "
                    ...
                    <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2"
                                    style="line-height: 49px;font-size: 13px;color: #000000;padding-left: 20px;border-right: unset;">
                                    {{ $data['customer_remarks'] }}</td>
                            </tr>
                        </tbody>
                    </table>
                                ...
                                <td style="padding: 30px;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" align="center"
                                        ...
                                        <tbody>
                                            <tr class="temp-social">
                                                <td><a href="javascript:void(0)"><i class="fa fa-facebook"></i></a>
                                                </td>
                                                <td><a href="javascript:void(0)"><i
                                                            class="fa fa-youtube-play"></i></a></td>
                                                <td><a href="javascript:void(0)"><i class="fa fa-twitter"></i></a>
                                                </td>
                                                <td><a href="javascript:void(0)"><i class="fa fa-google-plus"></i></a>
                                                </td>
                                                <td><a href="javascript:void(0)"><i class="fa fa-linkedin"> </i></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <p style="font-size:14px; margin:8px 0; color:#aba8a8;">2021 - 22
